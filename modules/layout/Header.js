            ...
            <div className="col-span-2 md:col-span-5">
                <div className='w-full'>
                    <div className="md:w-4/5 mx-auto">
                        <input type="search" className='w-full py-1 px-3 placeholder:text-gray-500 placeholder:text-sm rounded outline-none border' placeholder='Store, Collection, brands etc ...'/>
                    </div>
                </div>
            </div>
